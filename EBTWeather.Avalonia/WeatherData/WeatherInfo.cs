...
public record WeatherInfo(
    ...
    DateTime AsOfTime,
    List<CurrentWeatherInfo> TodayAndTomorrowWeatherInfo,
    List<HourlyWeatherInfo> HourlyPredictedWeatherInfoTodayAndTomorrow,
    List<DailyWeatherInfo> DailyPredictedWeatherInfo,
    List<HourlyWeatherInfo> HourlyPredictedWeatherInfo
);
